{* Displays current and upcoming public Tournament Listing as an HTML page. *}
...
<tr class="{cycle values="odd-row,even-row"} {$row.class}">
    ...
    <td>{if $event.summary}{$event.summary} (<a href="{crmURL p='civicrm/tournament/info' q="reset=1&id=`$event.event_id`"}" title="{ts}details...{/ts}">{ts}read more{/ts}...</a>){else}&nbsp;{/if}</td>
    <td class="nowrap">
