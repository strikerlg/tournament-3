{* this template is used for displaying tournament information *}

{if $registerClosed }
<div class="spacer"></div>
<div class="messages status no-popup">
  <div class="icon inform-icon"></div>
     &nbsp;{ts}Registration is closed for this tournament{/ts}
  </div>
{/if}
  ...
  <li>
    <div id="crm-event-links-wrapper">
      <span id="crm-event-configure-link" class="crm-hover-button">
        <span title="{ts}Configure this tournament.{/ts}" class="icon ui-icon-wrench"></span>
      </span>
