 ...
 * contacts
 */
class CRM_Tournament_Player_Form_Search_Basic extends CRM_Contact_Form_Search {
  ...
  public function addRules() {
    $this->addFormRule(array('CRM_Tournament_Player_Form_Search_Basic', 'formRule'));
  }
